...
const ArticlePage = ({ data }) => {
  ...
  return (
    ...
    <section id="comments" className="py-5 py-sm-3 py-md-3 py-lg-5 py-xl-5">
      <Container>
        <h3 className="text-center mb-4" style={{fontSize:'18px'}}>SHOWING {article.comments.length} COMMENTS</h3>
             
          {article.comments.map((comment,index) => (
          <div className="mb-4">
              <div className="profile-card pl-3">
                <span><i class="fa fa-user-circle"></i></span><strong className="color-secondary filson-pro-reg pl-3 color-secondary" style={{fontSize:'12px'}}>{comment.author.name}</strong><p></p> <strong className="pl-3" style={{fontSize:'12px'}}><a href="#" className="color-secondary">Reply</a></strong>
              </div>
    ...
    <section className="py-5 py-sm-3 py-md-3 py-lg-5 py-xl-5">
        <Container>
            <h3 className="text-center mb-4" style={{fontSize:'18px'}}>LEAVE A COMMENT</h3>
            <Row className="mx-0">
